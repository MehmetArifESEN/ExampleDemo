 ...
 */
package com.bilgeadam.cardealer.views;
...
public class AddCarPage extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
      //fieldları doldurup araba nesnesi oluşturcaz ara oluşunca bizi CarPAge göndersin
      //ekrana (arabanın markası) başarıyla eklendi diye kullancıya bilgi versin
