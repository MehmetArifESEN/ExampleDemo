...
public class CarPage extends javax.swing.JFrame {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        msj_text.setText("");
        //silerken kullancıya sorcak eminmisiniz?
        //ok eye basarsak silsin
        //sildikten sonrada 
        //textfieldda başarıyla silindi yazsın
        //eğer bir row seçmediyse lütfen bir row seçin
        int selectedRow = car_table.getSelectedRow();
        if (selectedRow == -1) {
            msj_text.setText("Lütfen bir kayıt seçin");
        } else {
            Long id = Long.parseLong(model.getValueAt(selectedRow, 0).toString());
            String message = "araba kaydını silemk istediğinize emin misiniz ?";
            String title = "Dikkat";
            ...
            if (secim == JOptionPane.OK_OPTION) {
                    ...
                    getCars();
                    clearArea();
                    msj_text.setText("Başarıyla silindi");
