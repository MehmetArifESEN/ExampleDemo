 ...
 */
public class UpdateCarForm extends javax.swing.JFrame {
...
/*
    ...
    */
    ...
    private void initComponents() {
        ...
        jLabel8.setText("Update Car Form Page");
    ...
    public void transferValues(Car car){
        brand_text.setText(car.getBrand());
        model_year_text.setText(car.getModelYear());
        car_model_text.setText(car.getCarModel());
        dealer_combo_box.setSelectedIndex((int) car.getDelaerShipId()-1);
        id = car.getId();
        eskiAd = car.getBrand();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UpdateCarForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UpdateCarForm().setVisible(true);
            }
        });
    }
